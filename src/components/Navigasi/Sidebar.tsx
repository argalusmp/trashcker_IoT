        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-primary-color-theme">
          <NavLink to="/" className="flex items-center ps-2.5 mb-5">
            ...
            <p className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
              Trash<span className="text-secondary-color-theme">cker</span>
            </p>
          </NavLink>
